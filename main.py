...
from MathModel.network_utils import network_math_cycle
from MathModel.grid_network_utils import grid_math_cycle
from Comparison import compare_all

if __name__ == '__main__':
    parser = ArgumentParser(description="AI Traffic Lights Controller")
    methods = ['fc', 'lqf', 'qlearning', 'search', 'mcts', 'logic', 'math', 'network', 'grid', 'compare']
    ...
    if args.method in ['fc', 'lqf']:
        ...
        network_math_cycle(n_episodes=args.episodes, render=args.render)
    elif args.method == 'grid':
        grid_math_cycle(n_episodes=args.episodes, render=args.render)
